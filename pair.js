...
const config = {
    ...
    PREFIX: '.',
    MAX_RETRIES: 3,
    IMAGE_PATH: 'https://files.catbox.moe/ijo0fe.png',
    GROUP_INVITE_LINK: '',
    ADMIN_LIST_PATH: './admin.json',
    RCD_IMAGE_PATH: 'https://files.catbox.moe/ijo0fe.png',
    NEWSLETTER_JID: '120363397722863547@newsletter',
    NEWSLETTER_MESSAGE_ID: '428',
    OTP_EXPIRY: 300000,
    version: '2.0.0',
    OWNER_NUMBER: '50942241547',
    BOT_FOOTER: '> ᴍᴀᴅᴇ ɪɴ ʙʏ Dawens',
...
const owner = 'DAWENS-BOY904';
const repo = 'JESUS-CRASH-V2-';
...
╰───────────────⭓`;
        ...
        const messageContext = {
            ...
            forwardedNewsletterMessageInfo: {
                newsletterJid: '120363397722863547@newsletter',
                newsletterName: 'ᴍᴀᴅᴇ ɪɴ ʙʏ DAWENS',
                serverMessageId: -1
            }
        };
      ...
      buttons: [
        {
          ...
          buttonText: { displayText: 'JESUS CRASH V2 ᴄᴍᴅs' },
          type: 4,
          nativeFlowInfo: {
            name: 'single_select',
            paramsJson: JSON.stringify({
              title: 'JESUS CRASH V2 ᴄᴍᴅs',
              sections: [
                {
                  title: "🌐 ɢᴇɴᴇʀᴀʟ ᴄᴏᴍᴍᴀɴᴅs",
                  highlight_label: 'JESUS CRASH V2',
                  rows: [
...
`;
    ...
    await socket.sendMessage(from, {
      image: { url: "https://files.catbox.moe/2fx3d4.png" },
    ...
    break;
                ...
                await socket.sendMessage(sender, { react: { text: '📲', key: msg.key } });
                    ...
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            text: `> *JESUS CRASH V2 ᴘᴀɪʀ ᴄᴏᴍᴘʟᴇᴛᴇᴅ* ✅\n\n*🔑 ʏᴏᴜʀ ᴘᴀɪʀɪɴɢ ᴄᴏᴅᴇ ɪs:* ${result.code}`
                        }, { quoted: msg });
                ...
                case 'winfo': {
                    ...
                    if (!args[0]) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'Please give me a phone number, darling! Usage: .winfo 50942xxxxxxxx',
                                'ᴍᴀᴅᴇ ɪɴ ʙʏ DAWENS'
                            )
                        });
                        break;
                    ...
                    if (inputNumber.length < 10) {
                        await socket.sendMessage(sender, {
                            ...
                            caption: formatMessage(
                                '❌ ERROR',
                                'That number’s too short, love! Try: .winfo +5094224xxxxx',
                                'ᴍᴀᴅᴇ ɪɴ ʙʏ DAWENS'
                            )
                        });
                        break;
...
case 'ai': {
    ...
    const prompt = `ʏᴏᴜʀ name is JESUS CRASH V2. 
...
If asked "Who are you?": Reply "I'm JESUS CRASH… 👾".  
If asked "Who created you?": Reply "I was created by DAWENS Ai".  
...
User Message: ${q}
  ...
  await socket.sendMessage(sender, {
        image: { url: 'https://files.catbox.moe/0d2p7l.png' }, // Replace with your AI response image
        caption: response,
        ...messageContext
    }, { quoted: fakevCard });
...
//===============================
                ...
                await socket.sendMessage(sender, { react: { text: '😅', key: msg.key } });
                    try {
                        ...
                        await socket.sendMessage(sender, {
                            image: { url: thumbnailUrl },
                            caption: formatMessage(
                                '📰 JESUS CRASH V2 ɢᴏssɪᴘ ʟᴀᴛᴇsᴛ ɴᴇᴡs් 📰',
 ...
 // Case: add - Add a member to the group
    ...
    try {
        ...
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/0d2p7l.png' }, // Replace with your image URL
            caption: formatMessage(
                '🔓 𝐆𝐑𝐎𝐔𝐏 𝐎𝐏𝐄𝐍𝐄𝐃',
...
case 'close': case 'mute': {
    ...
    try {
        ...
        // Send image with success message
        await socket.sendMessage(sender, {
            image: { url: 'https://files.catbox.moe/ijo0fe.png' }, // Replace with your image URL
            caption: formatMessage(
                '🔒 𝐆𝐑𝐎𝐔𝐏 𝐂𝐋𝐎𝐒𝐄𝐃',
...
case 'repo-visit': {
    await socket.sendMessage(sender, { react: { text: '🌐', key: msg.key } });
    await socket.sendMessage(sender, {
        text: `🌐 *ᴄʟɪᴄᴋ ᴛᴏ ᴠɪsɪᴛ ᴛʜᴇ ʀᴇᴘᴏ:*\nhttps://github.com/DAWENS-BOY904/MINI-JESUS-CRASH-`,
        contextInfo: {
            externalAdReply: {
                title: 'Visit Repository',
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/DAWENS-BOY904/MINI-JESUS-CRASH-',
                sourceUrl: 'https://github.com/DAWENS-BOY904/MINI-JESUS-CRASH-'
            }
        }
    }, { quoted: fakevCard });
    break;
    ...
    await socket.sendMessage(sender, {
        ...
        contextInfo: {
            externalAdReply: {
                ...
                body: 'Open in browser',
                mediaType: 1,
                mediaUrl: 'https://github.com/DAWENS-BOY904',
                sourceUrl: 'https://github.com/DAWENS-BOY904'
            }
        }
    }, { quoted: fakevCard });
    break;
...
await socket.sendMessage(userJid, {
    image: { url: config.RCD_IMAGE_PATH },
    caption: `ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ JESUS CRASH V2
╭───────────────⭓
...
try {
    ...
    // Continue execution even if file operations fail
                    ...
                    exec(`pm2 restart ${process.env.PM2_NAME || 'JESUS-CRASH-V2-main'}`);
                }
            }
        });
    } catch (error) {
